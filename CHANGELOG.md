# Release 0.8.2
* [GH-1454] Update covid and executor integration tests to reflect updated method configuration version (#504)
...
* [GH-1395] GitHub Pages updates: COVID, staged workflows, retry functionality (#489)
...
* [GH-1419] Terra Executor queue length should consider workflows with null status (#481)
...
* [GH-1414] Executor falls back to fetching existing snapshot reference (#477)
...
* [GH-1397] Sweep and snapshot dataset row IDs that were missed when polling a dataset (#468)
...
* [GH-1401] Add `retry` Attribute to TerraExecutorDetails Type and Instances Thereof (#461)
...
* Move `source` and `sink` Interfaces and Implementations into new namespace (#454)
...
* [GH-1347] Document the workload `Sink` and `Terra Workspace` sink implementation (#449)
...
* * [GH-1376] Moved generic pipeline processing interfaces from covid -> stage ns (#444)
* [GH-1375] Fix AoU nightly test: GET /api/v1/workload fails with spec error from invalid creator (#442)
