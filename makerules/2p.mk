...
SECOND_PARTY_REPOSITORIES := \
  $(patsubst %, $(SECOND_PARTY_DIR)/%.$(TIMESTAMP),$(REQUIRED_2P_REPOSITORIES))

DISTCLEAN_DIRS  += $(subst .$(TIMESTAMP),,$(SECOND_PARTY_REPOSITORIES))
...
$(SECOND_PARTY_REPOSITORIES): $(SECOND_PARTY_DIR)/%.$(TIMESTAMP):
