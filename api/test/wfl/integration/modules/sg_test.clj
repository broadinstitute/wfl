...
(deftest test-workload-state-transition
  (let [count           (atom 0)
    ...
    (with-redefs [cromwell/submit-workflows
                  mock-cromwell-submit-workflows
                  batch/batch-update-workflow-statuses!
                  (partial mock-batch-update-workflow-statuses! "Succeeded")
                  sg/register-workload-in-clio
                  increment-count]
...
(deftest test-retry-workflows-supported
  (with-redefs [cromwell/submit-workflows
                mock-cromwell-submit-workflows
                batch/batch-update-workflow-statuses!
                (partial mock-batch-update-workflow-statuses! "Failed")]
    (shared/run-workload-state-transition-test! (the-sg-workload-request))))
